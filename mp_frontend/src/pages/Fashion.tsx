...
const fashionCollections = [
  ...
  { name: 'Streetwear', image: '/images/fashion/streetwear.jpg' },
  { name: 'Formal Suits', image: '/images/fashion/formal-suit.jpg' },
  { name: 'Activewear', image: '/images/fashion/activewear.jpg' },
];

const featuredFashion = [
  { name: 'Floral Maxi Dress', image: '/images/fashion/floral-dress.jpg', price: '$89' },
  { name: 'Bomber Jacket', image: '/images/fashion/bomber-jacket.jpg', price: '$129' },
    ...
    <div className="pt-20">
      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          >
            <img
              src="/images/fashion/men-banner.jpg"
              alt="Men's Fashion"
          ...
          >
            <img
              src="/images/fashion/women-banner.jpg"
              alt="Women's Fashion"
              className="w-full h-96 object-cover group-hover:scale-105 transition-transform duration-500"
            />
            <div className="absolute inset-0 bg-black/40 flex items-center justify-center">
